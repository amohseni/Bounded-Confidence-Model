...
shinyUI(fluidPage(
  ...
  fluidRow(style = "background-color:#F2F2F2; margin-top: 30px; margin-bottom: 30px; padding: 10px",
           ...
           column(
             ...
             p("A lesson from the model is how very complex dynamics can emerge from relatively simple assumptions."),
             # Refernces:
             tags$b("Citations"),
             p(
  ...
  sidebarLayout(
    ...
    mainPanel(style = "padding: 20px; margin-bottom: 0px; margin-top: -30px;",
